...
public class GraphCreator extends Subject {
	...
	private final int quantityCol = 5; // the col # for the quantity of coin traded
	private final int stratCol = 1; // the col # for the broker's stratey
	private final int nameCol = 0; // the col # for the broker's name
	...
	/**
	 * Main graph method which is used to call other methods that create charts and
	 * graphics on the user interface
	 * 
	 * @param map         is a hashmap of trade and broker data
	 * @param data        is a table of data in form String[][]
	 * @param missingInfo is a boolean representing whether or not there is missing
	 *                    info in the broker table
	 */
	...
	private void createTableOutput(String[][] data) {
		for (int row = 0; row < data.length; row++) { // construct user interface table
			dtm.addRow(data[row]);
		}

		// creating trading activity table
	 ...
	 * @param map         is a hashmap of trade and broker data
	 * @param data        is a table of data in form String[][]
	 * @param missingInfo is a boolean representing whether or not information is
	 *                    missing
	 */
	private void createBar(HashMap<String, HashMap<String, Integer>> map, String[][] data, boolean missingInfo) {
		...
		// adding information to bar graph
