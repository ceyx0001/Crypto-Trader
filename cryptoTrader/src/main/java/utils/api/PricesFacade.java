...
public class PricesFacade {
     ...
     * @param dict     is a HashMap which is used as a dictionary to convert between
     *                 coin names, symbols, and ids
     * @param required is an ArrayList which contains required coins for a
     *                 transaction
     */
    public void getPrices(HashMap<String, Double> prices, HashMap<String, String> dict, ArrayList<String> required) {
        DataFetcher df = new DataFetcher();
        // iterate through the required coins and get their prices
     ...
     * 
     * @return CryptoDictionary object which represents a dictionary that converts
